...
abstract class AppLocalizations {
  ...
  /// No description provided for @totalCoinValue.
  ///
  /// In en, this message translates to:
  /// **'Total coin value'**
  String get totalCoinValue;

  /// No description provided for @bottomBarPortfolio.
  ///
  /// In en, this message translates to:
  /// **'Portfolio'**
  String get bottomBarPortfolio;

  /// No description provided for @bottomBarMovements.
  ///
  /// In en, this message translates to:
  /// **'Movements'**
  String get bottomBarMovements;

  /// No description provided for @titleMovements.
  ///
  /// In en, this message translates to:
  /// **'Movements'**
  String get titleMovements;

  /// No description provided for @titleCryptoDetails.
  ///
  /// In en, this message translates to:
  /// **'Details'**
  String get titleCryptoDetails;
